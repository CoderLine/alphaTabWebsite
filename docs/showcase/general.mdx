...
The mode is loaded from Guitar Pro files, can be [configured via alphaTex](/docs/alphatex/score-metadata.mdx#bracketextendmode) or configured via `score.stylesheet.bracketExtendMode` on the data model.
