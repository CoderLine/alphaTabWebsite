...
The mode is loaded from Guitar Pro files, can be [configured via alphaTex](/docs/alphatex/stylesheet.mdx#brackets-and-braces) or configured via `score.stylesheet.bracketExtendMode` on the data model.
