...
4. We add some UI elements for the user to play/pause the playback and show the current position.
...
The [`playerReady`](/docs/reference/api/readyforplayback) will tell us when to hide the indicator.
