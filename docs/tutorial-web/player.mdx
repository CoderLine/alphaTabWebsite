...
alphaTab ships a free SoundFont2 file for usage on your website. 
...
We will use the [`soundFontLoad`](/docs/reference/api/soundfontload) event to indicate the load progress of the (usually larger) SoundFont.
The [`playerReady`](/docs/reference/api/readyforplayback) will tell us when to hide the whole indicator.  
