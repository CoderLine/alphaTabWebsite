...
The result you might have already seen on the homepage in action:
...
As a pre-requisite you should be already familiar at least with the basics of web technologies like 
