...
* MusicXML files `.xml` which is an open XML based [standard](https://www.musicxml.com/) by an open consortium. 
* Capella `.cap` which is an open XML based [standard](https://www.capella.de/CapXML/3.0/) by Capella Software. 
