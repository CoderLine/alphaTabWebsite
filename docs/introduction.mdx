...
:::note
The JavaScript and .net version of alphaTab are sharing the same source code. 
We take our TypeScript code and compile it to C# using a special toolchain.
This way all platforms benefit from the same new features we add.
:::
...
* [alphaTex](/docs/alphaTex/introduction) which is a text based format optimized writing music notation in a textual format
