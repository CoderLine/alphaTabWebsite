...
<TypeTable>
    <TypeRow type="net" name="bool LoadSoundFont(byte[] raw)">
        Load the soundfont from the given raw bytes.
    </TypeRow>
    <TypeRow type="net" name="bool LoadSoundFont(Stream raw)">
        Load the soundfont from the given stream.
    </TypeRow>
    <TypeRow type="js" name="function loadSoundFont(arraybuffer)">
        Load the soundfont from the given raw bytes.
    </TypeRow>
    <TypeRow type="js" name="function loadSoundFont(uint8array)">
        Load the soundfont from the given raw bytes.
    </TypeRow>
    <TypeRow type="js" name="function loadSoundFont(url)">
        Load the soundfont from the given URL via AJAX.
    </TypeRow>
    <TypeRow type="js" name="alphaTab('loadSoundFont', arraybuffer)">
        Load the soundfont from the given raw bytes.
    </TypeRow>
    <TypeRow type="js" name="alphaTab('loadSoundFont', uint8array)">
        Load the soundfont from the given raw bytes.
    </TypeRow>
    <TypeRow type="js" name="alphaTab('loadSoundFont', url)">
        Load the soundfont from the given URL via AJAX.
    </TypeRow>
</TypeTable>
