...
<TabItem value="js">
<CodeBlock language="ts">{`isLooping : boolean = false;`}</CodeBlock>
</TabItem>
<TabItem value="cs">
<CodeBlock language="csharp">{`bool IsLooping { get; set; } = false`}</CodeBlock>
</TabItem>
<TabItem value="kt">
<CodeBlock language="kotlin">{`var isLooping: Boolean = false`}</CodeBlock>
</TabItem>
</Tabs>
