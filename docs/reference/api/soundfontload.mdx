...
<Signature style="block"
           js={[["identifier","soundFontLoad"],["token",":"],["whitespace"," "],["identifier","IEventEmitterOfT","/docs/reference/types/ieventemitteroft"],["token","<"],["identifier","ProgressEventArgs","/docs/reference/types/progresseventargs"],["token",">"],["token",";"]]}
/>
