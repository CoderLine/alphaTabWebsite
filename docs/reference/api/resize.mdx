...
<TypeTable>
    ...
    <TypeRow type="android" name="(args : ResizeEventArgs) -> Unit" />    
</TypeTable>
...
<ParameterTable>
    ...
    <ParameterRow platform="resize" name="args" type="alphaTab.ResizeEventArgs">
        The information about the resize event.  
    </ParameterRow>
</ParameterTable>
...
<ParameterTable>
    ...
    <ParameterRow platform="android" name="oldWidth" type="int">
        The size before the resizing happened. 
    </ParameterRow>
    ...
    <ParameterRow platform="android" name="newWidth" type="int">
        The size after the resize was complete. 
    </ParameterRow>
