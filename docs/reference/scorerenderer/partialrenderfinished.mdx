...
Since <span class="badge badge--info">1.2.3</span> the rendering of a chunk needs to be requested via the [`renderResult`](/docs/reference/scorerenderer/renderresult) method after
...
<ParameterTable>
    <ParameterRow platform="js" name="e" type="alphaTab.rendering.RenderFinishedEventArgs">
        The object containing the information about the chunk. 
    </ParameterRow>
    <ParameterRow platform="net" name="e" type="AlphaTab.Rendering.RenderFinishedEventArgs">
        The object containing the information about the chunk.
    </ParameterRow>
    <ParameterRow platform="android" name="e" type="alphaTab.rendering.RenderFinishedEventArgs">
        The object containing the information about the chunk.
    </ParameterRow>
</ParameterTable>
