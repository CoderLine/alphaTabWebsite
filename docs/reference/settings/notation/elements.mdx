...
Internally the setting is a [Map](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map) where the key must be a <Signature style="inline" js={[["identifier","NotationElement","/docs/reference/types/notationelement"]]} /> enumeration value.
