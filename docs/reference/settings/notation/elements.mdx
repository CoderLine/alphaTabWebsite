...
<CodeBadge type="js" name="Map<NotationElement, boolean>" /><CodeBadge type="net" name="Map<AlphaTab.NotationElement, bool>" /><CodeBadge type="android" name="alphaTab.collections.ObjectBooleanMap" />import MapDocs from '@site/docs/reference/types/notationelement/index.mdx';

<MapDocs inlined={true} />
## Examples
