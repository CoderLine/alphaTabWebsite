...
<CodeBadge type="js" name="NotationMode" /><CodeBadge type="net" name="AlphaTab.NotationMode" /><CodeBadge type="android" name="alphaTab.NotationMode" />import NotationModeDocs from '@site/docs/reference/types/notationmode/index.mdx';

<NotationModeDocs inlined={true} />