...
<TabItem value="js">
<CodeBlock language="ts">{`notationMode : NotationMode = NotationMode.GuitarPro;`}</CodeBlock>
</TabItem>
<TabItem value="cs">
<CodeBlock language="csharp">{`AlphaTab.NotationMode NotationMode { get; set; } = NotationMode.GuitarPro`}</CodeBlock>
</TabItem>
<TabItem value="kt">
<CodeBlock language="kotlin">{`var notationMode: alphaTab.NotationMode = NotationMode.GuitarPro`}</CodeBlock>
</TabItem>
</Tabs>
