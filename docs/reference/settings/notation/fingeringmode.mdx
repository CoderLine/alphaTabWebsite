...
<CodeBadge type="js" name="FingeringMode" /><CodeBadge type="net" name="AlphaTab.FingeringMode" /><CodeBadge type="android" name="alphaTab.FingeringMode" />import FingeringModeDocs from '@site/docs/reference/types/fingeringmode/index.mdx';

<FingeringModeDocs inlined={true} />