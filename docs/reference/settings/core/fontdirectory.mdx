...
Use <Signature style="inline" js={[["identifier","smuflFontSources","/docs/reference/settings/core/smuflfontsources"]]}>smuflFontSources</Signature>  for more flexible font configuration.
