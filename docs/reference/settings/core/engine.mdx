...
<TabItem value="js">
<CodeBlock language="ts">{`engine : string = "default";`}</CodeBlock>
</TabItem>
<TabItem value="cs">
<CodeBlock language="csharp">{`string Engine { get; set; } = "default"`}</CodeBlock>
</TabItem>
<TabItem value="kt">
<CodeBlock language="kotlin">{`var engine: String = "default"`}</CodeBlock>
</TabItem>
</Tabs>
