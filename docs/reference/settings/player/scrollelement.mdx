...
<table className="table table-striped table-condensed type-table">
    ...
    <tbody>
        <tr>
          <td><CodeBadge type="js" name="player.scrollElement" /></td>
          <td><CodeBadge type="js" name="string | HTMLElement" /></td>
          <td><code>'html,body'</code></td>
        </tr>
        <tr>
          <td><CodeBadge type="json" name="player.scrollElement" /></td>
          <td><CodeBadge type="json" name="string | HTMLElement" /></td>
          <td><code>"html,body"</code></td>
        </tr>
    </tbody>
</table>
