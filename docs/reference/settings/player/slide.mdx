...
## Type: [`alphaTab.SlidePlaybackSettings`](/docs/reference/types/slideplaybacksettings.mdx)

import SlidePlaybackSettingsDocs from '@site/docs/reference/types/slideplaybacksettings.mdx';

<SlidePlaybackSettingsDocs />