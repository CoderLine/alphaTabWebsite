...
<CodeBadge type="js" name="SlidePlaybackSettings" /><CodeBadge type="net" name="AlphaTab.SlidePlaybackSettings" /><CodeBadge type="android" name="alphaTab.SlidePlaybackSettings" />import SlidePlaybackSettingsDocs from '@site/docs/reference/types/slideplaybacksettings/index.mdx';

<SlidePlaybackSettingsDocs inlined={true} />