...
If the synthesizer is used (via <Signature style="inline" js={[["identifier","EnabledAutomatic","/docs/reference/types/playermode/#enabledautomatic"]]}>EnabledAutomatic</Signature>  or <Signature style="inline" js={[["identifier","EnabledSynthesizer","/docs/reference/types/playermode/#enabledsynthesizer"]]}>EnabledSynthesizer</Signature> ) a sound font is needed so that the midi synthesizer can produce the audio samples.
