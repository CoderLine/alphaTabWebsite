...
If this setting is enabled, options like <Signature style="inline" js={[["identifier","scrollSpeed","/docs/reference/settings/player/scrollspeed"]]} /> will not have an effect anymore.
