...
<TabItem value="js">
<CodeBlock language="ts">{`scrollOffsetX : number = 0;`}</CodeBlock>
</TabItem>
<TabItem value="cs">
<CodeBlock language="csharp">{`double ScrollOffsetX { get; set; } = 0`}</CodeBlock>
</TabItem>
<TabItem value="kt">
<CodeBlock language="kotlin">{`var scrollOffsetX: Double = 0`}</CodeBlock>
</TabItem>
</Tabs>
