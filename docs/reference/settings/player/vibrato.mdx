...
<CodeBadge type="js" name="VibratoPlaybackSettings" /><CodeBadge type="net" name="AlphaTab.VibratoPlaybackSettings" /><CodeBadge type="android" name="alphaTab.VibratoPlaybackSettings" />import VibratoPlaybackSettingsDocs from '@site/docs/reference/types/vibratoplaybacksettings/index.mdx';

<VibratoPlaybackSettingsDocs inlined={true} />