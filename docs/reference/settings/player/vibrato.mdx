...
## Type: [`VibratoPlaybackSettings`](/docs/reference/types/vibratoplaybacksettings/index.mdx)

import PropTypeDocs from '@site/docs/reference/types/vibratoplaybacksettings/index.mdx';
