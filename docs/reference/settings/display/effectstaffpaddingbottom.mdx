...
<TabItem value="js">
<CodeBlock language="ts">{`effectStaffPaddingBottom : number = 0;`}</CodeBlock>
</TabItem>
<TabItem value="cs">
<CodeBlock language="csharp">{`double EffectStaffPaddingBottom { get; set; } = 0`}</CodeBlock>
</TabItem>
<TabItem value="kt">
<CodeBlock language="kotlin">{`var effectStaffPaddingBottom: Double = 0`}</CodeBlock>
</TabItem>
</Tabs>
