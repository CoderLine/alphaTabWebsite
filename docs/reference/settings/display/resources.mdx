...
<TabItem value="js">
<CodeBlock language="ts">{`resources : RenderingResources = false;`}</CodeBlock>
</TabItem>
<TabItem value="cs">
<CodeBlock language="csharp">{`AlphaTab.RenderingResources Resources { get; set; } = false`}</CodeBlock>
</TabItem>
<TabItem value="kt">
<CodeBlock language="kotlin">{`var resources: alphaTab.RenderingResources = false`}</CodeBlock>
</TabItem>
</Tabs>
