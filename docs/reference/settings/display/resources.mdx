...
<CodeBadge type="js" name="RenderingResources" /><CodeBadge type="net" name="AlphaTab.RenderingResources" /><CodeBadge type="android" name="alphaTab.RenderingResources" />import RenderingResourcesDocs from '@site/docs/reference/types/renderingresources/index.mdx';

<RenderingResourcesDocs inlined={true} />