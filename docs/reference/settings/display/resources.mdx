...
## Type: [`RenderingResources`](/docs/reference/types/renderingresources/index.mdx)

import PropTypeDocs from '@site/docs/reference/types/renderingresources/index.mdx';
