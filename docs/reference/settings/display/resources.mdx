...
## Type: [`alphaTab.RenderingResources`](/docs/reference/types/renderingresources.mdx)

import RenderingResourcesDocs from '@site/docs/reference/types/renderingresources.mdx';

<RenderingResourcesDocs />