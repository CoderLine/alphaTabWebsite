...
<table className="table table-striped table-condensed type-table">
    ...
    <tbody>
        <tr>
          <td><CodeBadge type="js" name="display.systemsLayoutMode" /></td>
          <td><CodeBadge type="js" name="SystemsLayoutMode" /></td>
          <td><code>SystemsLayoutMode.Automatic</code></td>
        </tr>
        <tr>
          <td><CodeBadge type="json" name="display.systemsLayoutMode" /></td>
          <td><CodeBadge type="json" name="SystemsLayoutMode" /></td>
          <td><code>SystemsLayoutMode.Automatic</code></td>
        </tr>
        <tr>
          <td><CodeBadge type="net" name="Display.SystemsLayoutMode" /></td>
          <td><CodeBadge type="net" name="SystemsLayoutMode" /></td>
          <td><code>SystemsLayoutMode.Automatic</code></td>
        </tr>
        <tr>
          <td><CodeBadge type="android" name="display.systemsLayoutMode" /></td>
          <td><CodeBadge type="android" name="SystemsLayoutMode" /></td>
          <td><code>SystemsLayoutMode.Automatic</code></td>
        </tr>
    </tbody>
</table>
...
* Guitar Pro 6-8 <span class="badge badge--info">Since  1.3.0</span>
...
![system layout page example](/img/reference/property/systems-layout-page-examples.png)
...
### `enum alphaTab.SystemsLayoutMode`
...
* `alphaTab.SystemsLayoutMode.Automatic` - Use the automatic alignment system provided by alphaTab (default)
* `alphaTab.SystemsLayoutMode.UseModelLayout` - Use the systems layout and sizing information stored from the score model.
</TabItem>
<TabItem value="json">
* `"Automatic"` - Use the automatic alignment system provided by alphaTab (default)
