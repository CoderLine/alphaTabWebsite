...
<TabItem value="js">
<CodeBlock language="ts">{`systemsLayoutMode : SystemsLayoutMode = 1;`}</CodeBlock>
</TabItem>
<TabItem value="cs">
<CodeBlock language="csharp">{`AlphaTab.SystemsLayoutMode SystemsLayoutMode { get; set; } = 1`}</CodeBlock>
</TabItem>
<TabItem value="kt">
<CodeBlock language="kotlin">{`var systemsLayoutMode: alphaTab.SystemsLayoutMode = 1`}</CodeBlock>
</TabItem>
</Tabs>
