...
## Type: [`alphaTab.SystemsLayoutMode`](/docs/reference/types/systemslayoutmode.mdx)

import SystemsLayoutModeDocs from '@site/docs/reference/types/systemslayoutmode.mdx';

<SystemsLayoutModeDocs />