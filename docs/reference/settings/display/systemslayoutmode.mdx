...
<CodeBadge type="js" name="SystemsLayoutMode" /><CodeBadge type="net" name="AlphaTab.SystemsLayoutMode" /><CodeBadge type="android" name="alphaTab.SystemsLayoutMode" />import SystemsLayoutModeDocs from '@site/docs/reference/types/systemslayoutmode/index.mdx';

<SystemsLayoutModeDocs inlined={true} />