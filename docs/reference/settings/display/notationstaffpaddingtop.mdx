...
<TabItem value="js">
<CodeBlock language="ts">{`notationStaffPaddingTop : number = 5;`}</CodeBlock>
</TabItem>
<TabItem value="cs">
<CodeBlock language="csharp">{`double NotationStaffPaddingTop { get; set; } = 5`}</CodeBlock>
</TabItem>
<TabItem value="kt">
<CodeBlock language="kotlin">{`var notationStaffPaddingTop: Double = 5`}</CodeBlock>
</TabItem>
</Tabs>
