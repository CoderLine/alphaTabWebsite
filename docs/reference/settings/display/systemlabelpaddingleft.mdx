...
<TabItem value="js">
<CodeBlock language="ts">{`systemLabelPaddingLeft : number = 0;`}</CodeBlock>
</TabItem>
<TabItem value="cs">
<CodeBlock language="csharp">{`double SystemLabelPaddingLeft { get; set; } = 0`}</CodeBlock>
</TabItem>
<TabItem value="kt">
<CodeBlock language="kotlin">{`var systemLabelPaddingLeft: Double = 0`}</CodeBlock>
</TabItem>
</Tabs>
