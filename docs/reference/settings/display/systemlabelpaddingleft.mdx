...
<table className="table table-striped table-condensed type-table">
    ...
    <tbody>
        <tr>
          <td><CodeBadge type="js" name="display.systemLabelPaddingLeft" /></td>
          <td><CodeBadge type="js" name="number" /></td>
          <td><code>0</code></td>
        </tr>
        <tr>
          <td><CodeBadge type="json" name="display.systemLabelPaddingLeft" /></td>
          <td><CodeBadge type="json" name="number" /></td>
          <td><code>0</code></td>
        </tr>
        <tr>
          <td><CodeBadge type="net" name="Display.SystemLabelPaddingLeft" /></td>
          <td><CodeBadge type="net" name="double" /></td>
          <td><code>0</code></td>
        </tr>
        <tr>
          <td><CodeBadge type="android" name="display.systemLabelPaddingLeft" /></td>
