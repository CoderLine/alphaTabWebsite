...
<TabItem value="js">
<CodeBlock language="ts">{`barCountPerPartial : number = 10;`}</CodeBlock>
</TabItem>
<TabItem value="cs">
<CodeBlock language="csharp">{`double BarCountPerPartial { get; set; } = 10`}</CodeBlock>
</TabItem>
<TabItem value="kt">
<CodeBlock language="kotlin">{`var barCountPerPartial: Double = 10`}</CodeBlock>
</TabItem>
</Tabs>
