...
<table className="table table-striped table-condensed type-table">
    ...
    <tbody>
        <tr>
          <td><CodeBadge type="js" name="display.accoladeBarPaddingRight" /></td>
          <td><CodeBadge type="js" name="number" /></td>
          <td><code>3</code></td>
        </tr>
        <tr>
          <td><CodeBadge type="json" name="display.accoladeBarPaddingRight" /></td>
          <td><CodeBadge type="json" name="number" /></td>
          <td><code>3</code></td>
        </tr>
        <tr>
          <td><CodeBadge type="net" name="Display.AccoladeBarPaddingRight" /></td>
          <td><CodeBadge type="net" name="double" /></td>
          <td><code>3</code></td>
        </tr>
        <tr>
          <td><CodeBadge type="android" name="display.accoladeBarPaddingRight" /></td>
