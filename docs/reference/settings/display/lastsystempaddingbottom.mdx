...
<TabItem value="js">
<CodeBlock language="ts">{`lastSystemPaddingBottom : number = 0;`}</CodeBlock>
</TabItem>
<TabItem value="cs">
<CodeBlock language="csharp">{`double LastSystemPaddingBottom { get; set; } = 0`}</CodeBlock>
</TabItem>
<TabItem value="kt">
<CodeBlock language="kotlin">{`var lastSystemPaddingBottom: Double = 0`}</CodeBlock>
</TabItem>
</Tabs>
