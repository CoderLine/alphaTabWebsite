...
<table className="table table-striped table-condensed type-table">
    ...
    <tbody>
        <tr>
          <td><CodeBadge type="js" name="display.systemPaddingTop" /></td>
          <td><CodeBadge type="js" name="number" /></td>
          <td><code>10</code></td>
        </tr>
        <tr>
          <td><CodeBadge type="json" name="display.systemPaddingTop" /></td>
          <td><CodeBadge type="json" name="number" /></td>
          <td><code>10</code></td>
        </tr>
        <tr>
          <td><CodeBadge type="net" name="Display.SystemPaddingTop" /></td>
          <td><CodeBadge type="net" name="double" /></td>
          <td><code>10</code></td>
        </tr>
        <tr>
          <td><CodeBadge type="android" name="display.systemPaddingTop" /></td>
