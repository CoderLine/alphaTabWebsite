...
Windows desktop applications. AlphaTab comes with a .net version for either .net standard 2.0 or .net 8.0.  
...
**Windows Package (.net core 8.0 - WPF/WinForms)**
...
1. For rendering, either the built-in graphics library GDI+ can be used or alphaTab comes with a dependency to AlphaSkia for modern
