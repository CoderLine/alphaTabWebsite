...
In a real-world WPF application you would likely hand over the alphaTab API object to a ViewModel and hook up the UI
with the ViewModel using property and command bindings.
