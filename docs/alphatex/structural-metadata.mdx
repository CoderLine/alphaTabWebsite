...
Set the track to be played alone in the data model. 
...
Set the track to be muted (not played) in the data model. 
...
Set the track volume in the data model.
...
Set the track balance in the data model.
...
Set the midi instrument for this track.
...
The loaded soundfont needs to have this bank defined, otherwise
there might be no audio.
...
Enables the display of multibar rests if this track is shown as standalone.
...
Marks the start of a new staff.
...
Enable the display of standard notation.
...
Enable the display of numbered notation (Jianpu).
...
This metadata has no properties.
