...
- Guitar Pro 7 (alphaTab.exporter.Gp7Exporter) <span class="badge badge--info badge--header">since 1.2.0-alpha.75</span>
...
trigger a download, sent it to a server, save it to a file etc. 
